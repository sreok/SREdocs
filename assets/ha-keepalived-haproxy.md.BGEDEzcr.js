import{_ as s,c as n,o as a,a2 as p}from"./chunks/framework.U6HXpukZ.js";const k=JSON.parse('{"title":"【k8s高可用方案】使用Keepalived + Haproxy作为控制平面负载入口","description":"","frontmatter":{},"headers":[],"relativePath":"ha-keepalived-haproxy.md","filePath":"ha-keepalived-haproxy.md"}'),e={name:"ha-keepalived-haproxy.md"},l=p(`<h1 id="【k8s高可用方案】使用keepalived-haproxy作为控制平面负载入口" tabindex="-1">【k8s高可用方案】使用Keepalived + Haproxy作为控制平面负载入口 <a class="header-anchor" href="#【k8s高可用方案】使用keepalived-haproxy作为控制平面负载入口" aria-label="Permalink to &quot;【k8s高可用方案】使用Keepalived + Haproxy作为控制平面负载入口&quot;">​</a></h1><h3 id="安装keepalived" tabindex="-1">安装keepalived <a class="header-anchor" href="#安装keepalived" aria-label="Permalink to &quot;安装keepalived&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum -y install keepalived</span></span>
