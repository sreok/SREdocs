import{_ as s,c as n,o as a,a2 as p}from"./chunks/framework.U6HXpukZ.js";const m=JSON.parse('{"title":"使用kube-vip作为控制平面负载入口","description":"","frontmatter":{},"headers":[],"relativePath":"ha-kube-vip.md","filePath":"ha-kube-vip.md"}'),e={name:"ha-kube-vip.md"},l=p(`<h1 id="使用kube-vip作为控制平面负载入口" tabindex="-1">使用kube-vip作为控制平面负载入口 <a class="header-anchor" href="#使用kube-vip作为控制平面负载入口" aria-label="Permalink to &quot;使用kube-vip作为控制平面负载入口&quot;">​</a></h1><p>官方文档地址：<a href="https://kube-vip.io/docs/installation/static/" target="_blank" rel="noreferrer">Static Pods | kube-vip</a></p><h3 id="生成静态pod清单" tabindex="-1">生成静态pod清单 <a class="header-anchor" href="#生成静态pod清单" aria-label="Permalink to &quot;生成静态pod清单&quot;">​</a></h3><p>在使用kubeadm部署集群前，在每个master节点生成静态pod清单</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 设置vip，前提先ping一下，确保IP没有被占用</span></span>
